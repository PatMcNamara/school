...
class TreeOps {
    ...
    public static boolean find(Node tree, Comparable elem) {
    	if(elem.equals(tree.element()))
    		return true;
    	return find(tree.left(), elem) || 
    	       find(tree.right(), elem);
    }
    ...
    public static int shallowestLeaf(Node tree) {
    	...
    	if(tree.right() == null && tree.left() == null)
    		return 0;
    	if(tree.right() == null)
    		return shallowestLeaf(tree.left()) + 1;
    	if(tree.left() == null)
    		return shallowestLeaf(tree.right()) + 1;
    	return MIN(shallowestLeaf(tree.left()), shallowestLeaf(tree.right())) + 1;
    }
